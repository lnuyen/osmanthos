			<div class="col-xs-12 title-hero icy-bg">
				<h1 class="sr reveal-title page-title">Privacy Policy</h1>
			</div>

			<div class="col-xs-12 pad-80b faq">
				<div class="row row-fixed">
					<div class="sr reveal-content col-md-10 col-md-offset-1">
						<p><em>This Privacy Policy was last modified on January 1, 2018.</em></p>
						<p>osmanthōs ("us", "we", or "our") operates https://osmanthōs.com (the "Site"). This page informs you of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the Site.</p>
						<p>We use your Personal Information only for providing and improving the Site. By using the Site, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible at https://osmanthōs.com/terms.</p>
						...
						<p>osmanthōs has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party sites or services.</p>

						<p><strong>Changes To This Privacy Policy</strong><br />osmanthōs may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on the Site. You are advised to review this Privacy Policy periodically for any changes.</p>
