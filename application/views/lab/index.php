<div class="lab-column col-xs-12 col-md-4" id="lab--info">
    ...
    <div class="lab--info-wrapper row">
        <div class="col-xs-12">
            ...
            <p class="text-grey">Welcome to your personal fragrance lab. Save the formulas that you create with your <a href="<?php echo base_url('scent-kits'); ?>" title="scent kits">scent kits</a> here.</p>

            <p>/<span class="maison-bold">sent</span>/ /<span class="maison-bold">lab</span>/<br>
            an informal place for experimentation related to unique smells; especially ones that are pleasant.</p>
        </div>
    </div>
</div>

<div class="lab-column col-xs-12 col-sm-6 col-md-4" id="lab--raw-materials">
...
<div class="lab-column col-xs-12 col-sm-6 col-md-4" id="lab--formula">
    <h2 class="sr reveal-sequence">Formula</h2>

    <div class="lab--formula-wrapper row">

        <div class="col-xs-12" id="msg--empty-formula">
            <p class="text-grey">Your formula is empty. Add a raw material to get started.</p>
        </div>
        ...
        <form id="new-formula" action="<?php echo base_url('lab/create'); ?>" method="post">
                    ...
                    <div>
                        <div class="row">
                            ...
                            <div class="formula-rm-drops controls col-xs-6">
                                ...
                                <input type='text' name='<?php echo 'drops'.$i; ?>' class="drops" id='<?php echo 'drops'.$i; ?>' value="<?php echo set_value('drops'.$i); ?>" readonly=readonly />
                            ...
                            <div class="formula-rm-controls controls col-xs-3">
                                <input type='text' name='<?php echo 'percent'.$i; ?>' class="percent" id='<?php echo 'percent'.$i; ?>' value="<?php echo set_value('percent'.$i); ?>" readonly=readonly />
                            </div>                     
                            <input type='hidden' name='<?php echo 'rm'.$i; ?>' class='ingredient' value='<?php echo set_value('rm'.$i); ?>' />
                        </div>
                    </div>
                </div>  
            ...
            <div class="col-xs-12 visible-xs">
                ...
                <a class="toggle--lab-raw-materials hide max-rm btn btn-primary">View Raw Materials</a>
            ...
            <div class="toggle--lab-formula lab--formula-submit col-xs-12">
                ...
                <?php else: ?>
                    <p class="bg-warning" style="padding-left: 15px;">You must be <a href="<?php echo base_url('login'); ?>">logged in</a> to save your formula.</p>
                <?php endif; ?>
            </div>
